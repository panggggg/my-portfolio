    ...
    return (
        <div className="h-screen">
            ...
            <div class="flex bg-pink-200 max-w-2xl ml-40 mr-40 mb-2 shadow-lg">
                ...
                <div class="w-auto text-grey-darker text-left p-4">
                    <span class="text-lg font-bold pb-4 text-left">
                        Making question and answer game
                    </span>
                    <p class="leading-tight">
                        By Visual Basic for Application
                    </p>
                </div>
            </div>
            </div>
            ...
            <div class="flex bg-yellow-200 max-w-2xl ml-40  mr-40 mb-2 shadow-lg">
                ...
                <div class="w-auto text-grey-darker text-left p-4">
                    <span class="text-lg font-bold pb-4 text-left">
                        Boba Shop website for business
                    </span>
                    <p class="leading-tight">
            ...
            <div class="flex bg-purple-200 max-w-2xl ml-40  mr-40 mb-2 shadow-lg">
                ...
                <div class="w-auto text-grey-darker text-left p-4">
                    <span class="text-lg font-bold pb-4 text-left">
                        The Association Rules for Purchasing product in convenience stores
                    </span>
                    <p class="leading-tight">
                        By Weka
                    </p>
